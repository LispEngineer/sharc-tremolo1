...
// Specify the version of the framework designed to run on the SHARC Audio Module
// hardware with rev greater than 1.3 and less than 2.0 or 2.1 or greater. 
// specify the hardware version here
#define   SHARC_SAM_REV_1_3_OR_LATER                  FALSE
#define   SHARC_SAM_REV_2_1_OR_LATER                  TRUE

#if (SHARC_SAM_REV_1_3_OR_LATER)
    #define ADAU1761_PLL_CLKDIV_2 (0x1)

#elif(SHARC_SAM_REV_2_1_OR_LATER)
    #define ADAU1761_PLL_CLKDIV_2 (0x2)//Set the clock divider to 2 for SAM 2.0+
